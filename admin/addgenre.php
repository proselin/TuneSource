...
include('conn.php');
	if( $_SERVER['REQUEST_METHOD'] == 'POST'){
      ...
      $sql = "INSERT INTO genre(namegenre, image, description) VALUES (? ,? ,?)";
...
<body>
  ...
  <div class="form-group">
    <label for="ei1">Name genre</label>
    <input type="text" name="name" class="form-control" id="ei1" placeholder="namegenre" required="required" >
  </div> 
</div>
  <div class="form-group">
